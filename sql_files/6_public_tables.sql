...
drop table if exists public.sleeper_player_projections_info;
create table if not exists public.sleeper_player_projections_info(
    opponent varchar,
    company varchar,
    team varchar,
    player_id varchar,
...
drop table if exists public.sleeper_player_projections_player;
create table if not exists public.sleeper_player_projections_player(
    years_exp bigint,
    team varchar,
    position varchar,
    news_updated bigint,
...
drop table if exists public.sleeper_player_projections_metadata;
create table if not exists public.sleeper_player_projections_metadata(
    player_id varchar,
    week bigint,
    rookie_year varchar,
    source_id varchar,
    injury_override varchar,
    override_active varchar,
    years_exp_shift varchar,
    name varchar,
    inserted_timestamp timestamp without time zone constraint inserted_at_constraint default current_timestamp
);

drop table if exists public.sleeper_player_projections_stats;
create table if not exists public.sleeper_player_projections_stats(
    adp_dd_ppr numeric,
    player_id varchar,
    rec_yd numeric,
    rec_tgt numeric,
    ...
    pos_adp_dd_ppr numeric,
    gp numeric,
    bonus_rec_te numeric,
    rush_yd numeric,
    rush_fd numeric,
    rush_att numeric,
    bonus_rec_wr numeric,
    rush_td numeric,
    bonus_rec_rb numeric,
    pr_yd numeric,
    pr numeric,
    def_kr_yd numeric,
    fum_lost numeric,
    ...
    xpa numeric,
    fgmiss_50p numeric,
    fgmiss_40_49 numeric,
    fgmiss_30_39 numeric,
    fgm_yds numeric,
    fgm_50p numeric,
    fgm_40_49 numeric,
    fgm_30_39 numeric,
    ...
    pts_allow_14_20 numeric,
    blk_kick numeric,
    yds_allow_350_399 numeric,
    safe numeric,
    yds_allow_400_449 numeric,
    pts_allow_28_34 numeric,
    week varchar,
    st_td numeric,
    inserted_timestamp timestamp without time zone constraint inserted_at_constraint default current_timestamp
...
drop table if exists public.sleeper_player_info;
create table if not exists public.sleeper_player_info(
    rotoworld_id bigint,
...
drop table if exists public.sleeper_player_meatdata;
create table if not exists public.sleeper_player_meatdata(
    sleeper_id varchar,
    week varchar,
    rookie_year varchar,
    injury_override varchar,
